...
function ConsultLinks() {
    ...
    async function handleSubmit() {
        try {
            ...
            const url = new URL(HOST + '/consult-links');
    ...
    return (
        <div id='post-operators' className='main-container'>
            <div className='input-container'>
                <h1>Consultar Vínculos</h1>
                    <h2>Consultar vínculos entre produtos e operadores.</h2>
                    <br /><br />
                    <Input 
                        type='text' 
                        label="CPF / CNPJ Raíz" 
