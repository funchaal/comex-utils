...
function PostOperators() {
  ...
  async function handleUpload() {
    try {
      ...
      const url = HOST + '/operators-payload';
      ...
      if (status === 200) {
        setResponseTitle('Verifique o payload gerado abaixo e confirme para enviar os operadores.');
        setStage(1);
      } else {
